      ...
      <div className="container">
        ...
        <div className="about-contact grid grid-cols-2 gap-5 max-[767px]:grid-cols-1">
          <motion.div
            ...
            viewport={{ once: true }}
            className="about p-5 w-[100%] min-h-[385px] rounded-[10px] duration-300 cursor-pointer border-[2px] border-solid border-transparent bg-[#243945] hover:scale-[.8] hover:border-[#0ef] hover:shadow-shadowAbout"
          >
            <h2 className="text-[45px] text-[#0ef] text-center capitalize font-[900] mb-[15px] max-lg:text-[38px]">
              About Me
            </h2>
            ...
            <h3 className="text-3xl font-[900] capitalize text-[#0ef] mb-[10px] p-1">
              Place Of Birth:{" "}
              <span className="text-2xl text-white">Elmonofeya</span>
            </h3>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 50, filter: "blur(20px)" }}
            ...
            transition={{ duration: .4 }}
            viewport={{ once: true }}
            className="social py-5 w-[100%] min-h-[385px] rounded-[10px] duration-300 cursor-pointer border-[2px] border-solid border-transparent bg-[#243945] hover:scale-[.8] hover:border-[#0ef] hover:shadow-shadowAbout"
          >
            <h2 className="text-[45px] text-[#0ef] text-center capitalize font-[900] mb-[15px] max-lg:text-[38px]">
              Social Media
            </h2>
